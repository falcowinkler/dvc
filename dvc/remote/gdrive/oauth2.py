...
class OAuth2(object):
    ...
    def __init__(self, credentialpath, scopes, config):
    ...
    def _get_creds_id(self, client_id):
        plain_text = "|".join([client_id] + self.scopes)
    ...
    def _acquire_credentials(self):
        ...
        flow_runner = self.config.get(
            Config.SECTION_OAUTH2_FLOW_RUNNER, "console"
        )
    ...
    def _get_storage_lock(self):
        ...
        return creds_storage, Lock(creds_storage_dir, creds_storage + ".lock")
